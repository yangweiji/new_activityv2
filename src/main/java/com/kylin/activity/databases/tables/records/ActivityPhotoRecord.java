...
public class ActivityPhotoRecord extends UpdatableRecordImpl<ActivityPhotoRecord> implements Record7<Integer, Integer, String, String, Timestamp, Integer, String> {
     ...
     */
    @Override
    public ActivityPhotoRecord values(Integer value1, Integer value2, String value3, String value4, Timestamp value5, Integer value6, String value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ActivityPhotoRecord(Integer id, Integer activityId, String picture, String description, Timestamp created, Integer createdBy, String axtenalUrl) {
        super(ActivityPhoto.ACTIVITY_PHOTO);
