...
public class CommunityUserRecord extends UpdatableRecordImpl<CommunityUserRecord> implements Record8<Integer, Integer, Integer, String, Timestamp, Integer, Boolean, Timestamp> {

    private static final long serialVersionUID = -203187850;
     ...
     */
    @Override
    public Row8<Integer, Integer, Integer, String, Timestamp, Integer, Boolean, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row8<Integer, Integer, Integer, String, Timestamp, Integer, Boolean, Timestamp> valuesRow() {
     ...
     */
    @Override
    public CommunityUserRecord values(Integer value1, Integer value2, Integer value3, String value4, Timestamp value5, Integer value6, Boolean value7, Timestamp value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CommunityUserRecord(Integer id, Integer communityId, Integer userId, String role, Timestamp created, Integer level, Boolean isBlack, Timestamp memberTime) {
        super(CommunityUser.COMMUNITY_USER);
