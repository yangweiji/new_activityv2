...
public class Article extends TableImpl<ArticleRecord> {
    ...
    private static final long serialVersionUID = 1840590744;

    /**
     * The reference instance of <code>activity.article</code>
     */
    ...
    /**
     * The column <code>activity.article.id</code>. 编号
     */
    ...
    /**
     * The column <code>activity.article.community_id</code>. 0：表示平台发布， &gt;0 : 团体发布
     */
    ...
    /**
     * The column <code>activity.article.body</code>. 正文
     */
    public final TableField<ArticleRecord, String> BODY = createField("body", org.jooq.impl.SQLDataType.CLOB, this, "正文");

    /**
     * The column <code>activity.article.status</code>. 状态 0 草稿 1 发布 -1 禁用
     */
    ...
    /**
     * The column <code>activity.article.publish_time</code>. 发布时间 显示时按时间倒序排
     */
    ...
    /**
     * Create a <code>activity.article</code> table reference
     */
    public Article() {
    ...
    /**
     * Create an aliased <code>activity.article</code> table reference
     */
