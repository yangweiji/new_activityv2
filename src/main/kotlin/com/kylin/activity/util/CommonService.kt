...
class CommonService {
     ...
     */
    @Autowired
    val smsTemplateListProperties: SmsTemplateListProperties? = null
     ...
     */
    @Throws(ClientException::class)
    fun sendSms(mobile: String, code: String, templateId: Int): SendSmsResponse {
        ...
        //必填:短信签名-可在短信控制台中找到
        request.signName = smsTemplateListProperties!!.sign
        //必填:短信模板-可在短信控制台中找到
        request.templateCode = smsTemplateListProperties!!.templates!![templateId].code
