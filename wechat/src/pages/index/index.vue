    ...
    <div class="page__bd">
      ...
      <div class="weui-tab">
        ...
        <div class="weui-tab__panel">
          <div class="weui-tab__content" :hidden="activeIndex != 'b5'">
          ...
          <div class="weui-tab__content" :hidden="activeIndex != 'b13'">
          ...
          <div class="weui-tab__content" :hidden="activeIndex != 'b12'">
            选项3的内容
          </div>

          <div class="weui-tab__content" :hidden="activeIndex != 'b10,b11'">
            选项4的内容
          </div>
