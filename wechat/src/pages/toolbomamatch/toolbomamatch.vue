  ...
  <div class="page">
    ...
    <div class="page__bd">
      ...
      <div v-if="item.matchItem" class="weui-cells__title c-text-center c-table">
        <div class="c-text-primary" v-if="item.matchItem.age[0]<80">
    ...
    data() {
      return {
        ...
        matchDatas: {
          ...
          {          
            age: [35, 39],
            standard: ["2:50:00", "3:00:00", "3:05:00", "3:10:00"],
          },
          {
            age: [40, 44],
            standard: ["2:55:00", "3:05:00", "3:10:00", "3:15:00"],
          },
          {
           age: [45, 49],
            standard: ["3:05:00", "3:15:00", "3:20:00", "3:25:00"],
          },
          {
          age: [50, 54],
          standard: ["3:10:00", "3:20:00", "3:25:00", "3:30:00"],
          },
          {
           age: [55, 59],
            standard: ["3:20:00", "3:30:00", "3:35:00", "3:40:00"],
          },
          {
           age: [60, 64],
           standard: ["3:35:00", "3:45:00", "3:50:00", "3:55:00"],
          },
          {
          age: [65, 69],
          standard: ["3:50:00", "4:00:00", "4:05:00", "4:10:00"],
          },
          {
           age: [70, 74],
            standard: ["4:05:00", "4:15:00", "4:20:00", "4:25:00"],
          },
          {
           age: [75, 79],
            standard: ["4:20:00", "4:30:00", "4:35:00", "4:40:00"],
          },
          {
           age: [80,Number.POSITIVE_INFINITY],
            standard: ["4:35:00", "4:45:00", "4:50:00", "4:55:00"],
          },
          ],
           '女': [{
            age: [18, 34],
            standard: ["3:15:00", "3:25:00", "3:30:00", "3:35:00"],    
          },
          {
           age: [35, 39],
            standard: ["3:20:00", "3:30:00", "3:35:00", "3:40:00"], 
          ...
          {
            age: [40, 44],
            standard: ["3:25:00", "3:35:00", "3:40:00", "3:45:00"],
          },
          {
             age: [45, 49],
            standard: ["3:35:00", "3:45:00", "3:50:00", "3:55:00"],
          ...
          {
            age: [50, 54],
            standard: ["3:40:00", "3:50:00", "3:55:00", "4:00:00"],  
          },
          {
            age: [55, 59],
            standard: ["3:50:00", "4:00:00", "4:05:00", "4:10:00"],
          ...
          {
            age: [75, 79],
            standard: ["4:50:00", "5:00:00", "5:05:00", "5:10:00"],
          },
          {
           age: [80,Number.POSITIVE_INFINITY],
            standard: ["5:05:00", "5:15:00", "5:20:00", "5:25:00"],
          },
          ],         
        }
      };
