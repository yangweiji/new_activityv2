<template>
  <div class="page">
    ...
    <div class="page__bd">
      ...
      <div class="weui-toptips" :class="{'weui-toptips_warn': isError, 'weui-toptips_primary': !isError}" v-if="showTopTips">{{infoMessage}}</div>
      ...
      <div class="weui-cells weui-cells_after-title">
        <div class="weui-cell weui-cell_input weui-cell_vcode">
          ...
          <div class="weui-cell__ft">
            <div class="weui-vcode-btn" @click="bindGetVerCode" v-if="validateUserName" :class="{'vcode-btn-disabled': !canGetVerCode}">获取验证码
          ...
          that.$kyutil.get("/pub/wx/auth/getMiniAppUserInfo", param).then(res => {
            ...
            if (res.code == 200) {
              ...
              that.$kyutil.post("/pub/wx/auth/userLogin", param).then(res => {
                ...
                if (res.code == 200) {
                  //取得用户信息
                  that.$kyutil.get("/pub/wx/auth/getUserInfo", {
                    "openid": param.openId,
