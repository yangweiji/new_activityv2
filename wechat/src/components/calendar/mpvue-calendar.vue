    ...
    <table cellpadding="5">
      ...
      <div class="c-body">
        <tr v-for="(day,k1) in days" :key="k1" style="{'animation-delay',(k1*30)+'ms'}">
          <td v-for="(child,k2) in day" :key="k2" :class="{'selected':child.selected && !noSelected,'disabled':child.disabled, 'has-event':child.eventName!=undefined}" @click="select(k1,k2,$event)" class="day">
